...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        $_SESSION['success'] = 'Clinic account added successfully!';
        header('Location: add_clinic.php');
        exit();
    } else {
        $_SESSION['error'] = 'There was an error adding the Clinic.';
        header('Location: add_clinic.php');
        exit();
    }
}
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="manage_clinic.php">MANAGE CLINIC</a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div style="background-color: #001968 !important;" class="card-header">
                                    <h3 class="card-title" style="font-size: 25px;">ADD NEW CLINIC</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
