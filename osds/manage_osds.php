...
// READ OSDS
$get_osds = "SELECT * FROM `tbl_admin` WHERE role = 'osds'";
$stmt_get_osds = $conn->query($get_osds);
$osds = $stmt_get_osds->fetchAll(PDO::FETCH_ASSOC);
// END READ OSDS
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">MANAGE OSDS</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div style="background-color: #001968 !important; color: whitesmoke !important" class="card-header">
                                    <h3 class="card-title" style="font-size: 25px;">MANAGE OSDS</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <button onclick="window.location.href='add_osds.php';" class="btn btn-primary mb-3">+ ADD OSDS</button>
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php foreach ($osds as $osds_account): ?>
                                                <tr>
                                                    <td><img style="height: 70px; width: 70px; border-radius: 50px;" src="images/profile/<?php echo $osds_account['profile_image']; ?>" alt="Profile Picture" /></td>
                                                    <td><?php echo $osds_account['fullname'] ?></td>
                                                    <td><?php echo $osds_account['email'] ?></td>
