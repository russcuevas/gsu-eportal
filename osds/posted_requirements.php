...
// READ POSTED REQUIREMENTS
$get_posted_requirements = "SELECT * FROM `tbl_osds_post_requirements`";
$stmt_get_posted_requirements = $conn->query($get_posted_requirements);
$posted_requirement = $stmt_get_posted_requirements->fetchAll(PDO::FETCH_ASSOC);
// END READ POSTED REQUIREMENTS
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">POSTED REQUIREMENTS</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div style="background-color: #001968 !important; color: whitesmoke !important" class="card-header">
                                    <h3 class="card-title" style="font-size: 25px;">POSTED REQUIREMENTS</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <button onclick="window.location.href='add_requirements.php';" class="btn btn-primary mb-3">+ ADD REQUIREMENTS</button>
                                    <table id="myTable" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Type of requirements</th>
                                                <th>Created</th>
                                                <th>Updated</th>
                                                <th>PDF</th>
                                                <th>Actions</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($posted_requirement as $posted_requirements): ?>
                                                <tr>
                                                    <td><?php echo $posted_requirements['requirements_description'] ?></td>
                                                    <td><?php echo $posted_requirements['created_at'] ?></td>
                                                    <td><?php echo $posted_requirements['updated_at'] ?></td>
                                                    <td>
                                                        <?php
                                                        $file_extension = strtolower(pathinfo($posted_requirements['requirements_upload'], PATHINFO_EXTENSION));
                                                        $file_path = '../assets/uploads/posted_requirements/' . $posted_requirements['requirements_upload'];
