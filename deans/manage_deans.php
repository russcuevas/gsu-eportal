...
// READ DEANS
$get_deans = "SELECT * FROM `tbl_admin` WHERE role = 'deans'";
$stmt_get_deans = $conn->query($get_deans);
$dean = $stmt_get_deans->fetchAll(PDO::FETCH_ASSOC);
// END READ DEANS
...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">MANAGE DEANS</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <button onclick="window.location.href='add_deans.php';" class="btn btn-primary mb-3">+ ADD DEAN</button>
                                            ...
                                            <?php foreach ($dean as $deans): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <!-- DELETE MODAL -->
                                                        <div class="modal fade" id="deleteDeansModal" tabindex="-1" role="dialog" aria-labelledby="deleteDeansModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="deleteDeansModalLabel">Confirm Deletion</h5>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <form id="deleteUserForm" method="POST" action="delete_deans.php">
                                                                            <input type="hidden" name="id" id="deans_id_delete">
    ...
    <script>
        function setDeansId(DeansId) {
            document.getElementById('deans_id_delete').value = DeansId;
        }
    </script>
