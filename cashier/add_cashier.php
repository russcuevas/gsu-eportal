...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] == 0) {
        ...
        if (move_uploaded_file($profile_image['tmp_name'], $target_file)) {
            ...
            header('Location: add_cashier.php');
            exit();
        }
    } else {
    ...
    if ($stmt->execute()) {
        ...
        $_SESSION['error'] = 'There was an error adding the Cashier.';
        header('Location: add_cashier.php');
        exit();
    }
}
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="manage_cashier.php">MANAGE CASHIER</a></li>
                                <li class="breadcrumb-item active">ADD NEW CASHIER</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div style="background-color: #001968 !important;" class="card-header">
                                    <h3 class="card-title" style="font-size: 25px;">ADD NEW CASHIER</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
